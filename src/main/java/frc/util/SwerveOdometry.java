...
public class SwerveOdometry implements Runnable {
    ...
    public void iterate() {
        ...
        Vector2D translationVector = Vector2D.addVectors(frChange,flChange,blChange,brChange).scale(0.25*SwerveModule.UNITS_TO_FT_DRIVE).rotate(-this.theta, true);
    ...
    public double getVelocity() {
        ...
        return Vector2D.addVectors(frVel,flVel,blVel,brVel).scale(0.25*SwerveModule.UNITS_TO_FT_DRIVE*10).getLength();
    }
}